...
# # Tuned model + learnable text embedding
# python main.py \
#       --backbone ViT-B/32 \
#       --incremental dataset \
#       --data_root ${DATA_DIR} \
...
#       --use_tuned_text_embedding \
#       --exp_name AnytimeCL_task_incremental_tuned_text_embedding


# Fixed finetuned model + learnable text embedding
python main.py \
      --backbone ViT-B/32 \
      --incremental dataset \
      --data_root ${DATA_DIR} \
      ...
      --use_tuned_text_embedding \
      --fix_finetuned_model \
      --exp_name AnytimeCL_task_incremental_fixed_finetuned_model_learnable_text_embedding

# Second time, fix p_ft_0_1
python main.py \
      --backbone ViT-B/32 \
      --incremental dataset \
      --data_root ${DATA_DIR} \
      ...
      --ema_exemplar_per_class_acc \
      --ema_exemplar_per_class_acc_decay ${ema_decay} \
      --exp_name AnytimeCL_task_incremental_fix_p_ft_0_1
